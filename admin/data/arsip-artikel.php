        ...
        <section id="breadcrumbs" class="breadcrumbs">
            <div class="container">
                <ol>
                    ...
                    <li>Data KIM</li>
                    <li><a href="arsip-artikel.php">Arsip Artikel</a></li>
                </ol>
            </div>
        </section>
        <!-- End Breadcrumbs -->
            ...
            <div class="container">
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <tr>
                            <th scope="row">1</th>
                            <td><img src="../img/sosialisasi.jpeg" alt=""></td>
                            <td>Sosialisasi Website KIM</td>
                            <td>Sosial Budaya</td>
                            <td>1 Feb 2020</td>
                            <td><a href=""><button type="button" class="btn btn-success">Setujui</button></a>
                                <a href=""><button type="button" class="btn btn-danger">Tolak</button></a>
                            </td>
                        </tr>
                        <tr>
                            <th scope="row">2</th>
                            <td><img src="../img/sosialisasi-2.jpeg" alt=""></td>
                            <td>Sosialisasi Website KIM</td>
                            <td>Sosial Budaya</td>
                            <td>1 Feb 2020</td>
                            <td><a href=""><button type="button" class="btn btn-success">Setujui</button></a>
