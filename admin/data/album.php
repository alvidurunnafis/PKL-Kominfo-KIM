...
$sql = "SELECT profil.Id_Profil, profil.Nama_KIM, COUNT(galeri.Pemilik) AS Jumlah_galeri , profil.Foto_Profil FROM galeri, profil WHERE galeri.Pemilik = profil.Id_Profil GROUP BY id_profil";
                    ...
                    foreach ($hasil as $value) { ?>
                        <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                            <div class="artikel-box">
                                <img src="../../image/<?= $value['Foto_Profil'] ?>" alt="" class="img-fluid">
                                <h4><a href=""><?php echo $value['Nama_KIM']; ?></a></h4>
                                <div class="entry-meta">
                                    <ul>
                                        <li class="d-flex align-items-center"><i class="fa-regular fa-images"></i><span><?php echo $value['Jumlah_galeri'] ?></span></li>
                                    </ul>
                                </div>
                                <div class="entry-content">
                                    <div class="read-more">
                                        <a href="album_detail.php?id=<?= $value['Id_Profil'] ?>">See Photos</a>
                                    </div>
                                </div>
                            </div>
                        </div>
