...
$sql = "SELECT profil.Id_Profil, profil.Nama_KIM, COUNT(artikel.Penulis) AS Jumlah_Jurnal , profil.Foto_Profil FROM artikel, profil WHERE artikel.Penulis = profil.Id_Profil GROUP BY id_profil";
...
<body>
    ...
    <main id="main">
        ...
        <div class="container my-4">
            <h5 class="my-3">Data KIM</h5>
            <div class="row gy-2">
                <?php
                foreach ($hasil as $value) {
                ?>
                    <div class="col-md-3 my-3">
                        <a href="admin-detail.php?id=<?= $value['Id_Profil'] ?>">
                            <div class="card" style="border-radius: 17px;">
                                <img class="card-img-top" src="../../image/<?= $value['Foto_Profil'] ?>" alt="Card image cap">
                                <div class="card-body" style="border-radius: 0px 0px 17px 17px;">
                                    <h5 class="card-title text-success"> <?php echo $value['Nama_KIM']; ?></h5>
                                    <p class="card-text text-dark"><?php echo $value['Jumlah_Jurnal'] ?> </p>
                                </div>
                            </div>
                        </a>
                    </div>
