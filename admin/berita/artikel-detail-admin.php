...
<body>
    ...
    <main id="main">
        ...
        <section id="breadcrumbs" class="breadcrumbs">
            <div class="container">
                <ol>
                    ...
                    <li><a href="artikel-admin.php">Artikel</a></li>
                    <li>Detail</li>
                </ol>
            </div>
        </section>
        ...
        <!-- ======= Artikel Section ======= -->
        <section id="artikel-single" class="artikel-single">
            <div class="container">

                <div class="row">
                    <div class="col-lg-20 entries">
                        <div class="artikel entry-single">
                            <div class="entry-img">
                                <img src="../../image/sosialisasi-2.jpeg" alt="" class="img-fluid">
                            </div>

                            <h4 class="entry-title">
                                <a href="">Sosialisasi Website KIM</a>
                            </h4>
                            ...
                            <div class="entry-content">
                                ...
                                <p>Kamis, 31 Maret 2021 Dinas Komunikasi dan Informatika Kabupaten melakukan Sosialisasi terkait Revitalisasi Kelompok Informasi Masyarakat (KIM) Kabupaten Malang di Ruang rapat Anusapati Kantor Bupati Malang yang dihadiri perwakitan dari 33 kecamatan se-Kabupaten Malang. Plt.Kepala Dinas Komunikasi dan Informatika Kabupaten Malang, Drs.M.Nur Fuad Fauzi,M.T saat membuka acara menyampaikan bahwa KIM adalah kelompok yang dapat membantu pemerintah dalam menyampaikan informasi yang akurat kepada masyarakat agar masyarakat kita tidak terkena infomasi yang salah / HOAX. Selain itu juga berharap KIM dapat terbentuk di seluruh desa di 33 Kecamatan Kabupaten Malang.</p>
                                <p>Dalam Sosialisasi Ini Dinas Kominfo menghadirkan Narasumber dari Dinas Kominfo Provinsi Jawa Timur Eko Setiawan, S.I.Kom, M.Med.Kom yang membawakan materi tentang Revitalisasi Kim Sebagai Media Jurnalisasi Warga</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row justify-content-between">
                    ...
                    <div class="col-auto">
                        <div class="social-links d-none d-md-flex align-items-center">
                            <a onclick="_fb();" alt="facebook" class="facebook"><i class="fa-brands fa-facebook"></i></a>
                            <a onclick="_whatsapp();" alt="whatsapp" class="whatsapp"><i class="fa-brands fa-whatsapp"></i></a>
                            <a onclick="_twitter();" alt="twitter" class="twitter"><i class="fa-brands fa-twitter"></i></a>
                            <a onclick="_telegram();" alt="telegram" class="telegram"><i class="fa-brands fa-telegram"></i></a>
                        </div>
                    </div>
                </div>
