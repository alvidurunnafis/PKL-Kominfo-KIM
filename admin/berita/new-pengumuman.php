    ...
    <main id="main">
        ...
        <section id="new-post" class="new-post">
            <div class="container">
                ...
                <form action="../../php/insert-pengumuman.php" method="POST">
                    <div class="form-group">
                        <label>Judul Pengumuman</label>
                        <input type="text" class="form-control" name="judul-pengumuman" id="judul" placeholder="Masukkan Judul Pengumuman">
                    </div>
                    <div class="form-group">
                        <label>Isi Pengumuman</label>
                        <textarea class="form-control" id="exampleFormControlTextarea1" name="isi-pengumuman" rows="8" placeholder="Masukkan Isi Pengumuman"></textarea>
                    </div>
