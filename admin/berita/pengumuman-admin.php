...
$sql = "SELECT Id_Pengumuman, Judul_Pengumuman, Isi_Pengumuman, Tanggal_Insert, username FROM pengumuman, akun WHERE pengumuman.Penulis = akun.id ORDER BY Id_Pengumuman DESC";
        ...
        <section id="pengumuman" class="pengumuman">
            <div class="container">
                ...
                <div class="row justify-content-between">
                    ...
                    <div class="col-auto">
                        <div class="new-post">
                            <a href="new-pengumuman.php">New Post</a>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col">
                                    <h4 class="entry-title">
                                        <a href="pengumuman-detail-admin.php?id=<?= $value['Id_Pengumuman'] ?>"><?= $value['Judul_Pengumuman'] ?></a>
                                    </h4>

                                    <div class="entry-meta">
                                        <ul>
                                            <li class="d-flex align-items-center"><i class="fa-regular fa-user"></i><span>Admin</span></li>
                                            <li class="d-flex align-items-center"><i class="fa-regular fa-calendar-days"></i><span>Posted on <time datetime="2020-01-01"><?= $value['Tanggal_Insert'] ?></time></span></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="col-3">
                                    <a href="edit-pengumuman.php?id=<?= $value['Id_Pengumuman'] ?>" type="button" class="btn btn-warning px-4">Edit</a>
                                    <a href="../../php/delete-pengumuman.php?id=<?= $value['Id_Pengumuman'] ?>" type="button" class="btn btn-danger">Hapus</a>
