...
$sql = "SELECT artikel.Id_Artikel, artikel.Judul_Artikel, artikel.Isi_Artikel, artikel.Tanggal, artikel.Tema, artikel.Gambar, artikel.Status, profil.Nama_KIM FROM artikel, profil WHERE artikel.Penulis = profil.Id_Profil";
    ...
    <main id="main">
        ...
        <section id="artikel" class="artikel">
            <div class="container">
                ...
                $data_artikel = mysqli_query($koneksi, "SELECT artikel.Id_Artikel, artikel.Judul_Artikel, artikel.Isi_Artikel, artikel.Tanggal, artikel.Tema, artikel.Gambar, artikel.Status, profil.Nama_KIM FROM artikel, profil WHERE artikel.Penulis = profil.Id_Profil limit $halaman_awal, $batas");
                $nomor = $halaman_awal + 1;
                ?>

                <div class="row arikel-kotak">
                    <?php
                    if (empty($data_artikel)) {
                    ?>
                        <p class="align-self-center col text-center text-artikel">Belum Ada Artikel</p>
                    <?php
                    }
                    ...
                    ?>
                        ...
                        <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                            <div class="artikel-box">
                                <img src="../../file/gallery/<?= $d['Gambar'] ?>" alt="" class="img-fluid">
                                <h4><a href=""><?= $d['Judul_Artikel'] ?></a></h4>
                                <div class="entry-meta">
                                    <ul>
                                        <li class="d-flex align-items-center"><i class="fa-regular fa-user"></i><span><?= $d['Nama_KIM'] ?></span></li>
                                        <li class="d-flex align-items-center"><i class="fa-regular fa-calendar-days"></i><span><time datetime="2020-01-01"><?= $d['Tanggal'] ?></time></span></li>
                                    </ul>
                                </div>

                                <div class="entry-content">
                                    <p><?= substr($d['Isi_Artikel'], 0, 150) ?>....</p>
                                    <div class="read-more">
                                        <a href="artikel-detail-user.php">Read More</a>
                                    </div>
                                </div>
                            </div>
                        </div>
